...
namespace libJDBCBridge.JavaBridge {
		...
		public struct JNI {
			public unsafe JNI_FTable* fTable;
		}
		
		public struct JVM {
			public unsafe JVM_FTable* fTable;
		}

		#pragma warning disable 169 //Value used by natives
		public struct JavaClass  {internal IntPtr value;}
		public struct JavaMethod {internal IntPtr value;}
		public struct JavaObject {internal IntPtr value;}
		#pragma warning restore 169


		[StructLayout(LayoutKind.Explicit)]
		public struct JavaValue {
			...
			[FieldOffset(0)] public JavaObject    refValue;

			public static implicit operator JavaValue(      char value) => new JavaValue{  charValue = value};
			public static implicit operator JavaValue(      byte value) => new JavaValue{  byteValue = value};
			public static implicit operator JavaValue(     sbyte value) => new JavaValue{ sbyteValue = value};
			public static implicit operator JavaValue(     short value) => new JavaValue{ shortValue = value};
			public static implicit operator JavaValue(    ushort value) => new JavaValue{ushortValue = value};
			public static implicit operator JavaValue(       int value) => new JavaValue{   intValue = value};
			public static implicit operator JavaValue(      uint value) => new JavaValue{  uintValue = value};
			public static implicit operator JavaValue(      long value) => new JavaValue{  longValue = value};
			public static implicit operator JavaValue(     ulong value) => new JavaValue{ ulongValue = value};
			public static implicit operator JavaValue(     float value) => new JavaValue{ floatValue = value};
			public static implicit operator JavaValue(    double value) => new JavaValue{doubleValue = value};
			public static implicit operator JavaValue(JavaObject value) => new JavaValue{   refValue = value};
		}
		
		//To whatever jni engineer made me do this:
		//You make me sad.
		[StructLayout(LayoutKind.Sequential)]  
		public struct JNI_FTable {
